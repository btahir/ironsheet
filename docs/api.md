...
- Inspect sheets, features, auto filters, comments, conditional formats, data validations, defined names, formulas, hyperlinks, merged cells, tables, and styles.
- Read and write cells, ranges, appended rows, worksheet auto filters, conditional-formatting blocks, data validations, defined names, external hyperlinks, merged cells, table rows, sheet names, sheet visibility, table names, table columns, and cell styles.
