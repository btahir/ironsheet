...
- Read and write cells, ranges, appended rows, defined names, external hyperlinks, merged cells, table rows, sheet names, table names, table columns, and cell styles.
