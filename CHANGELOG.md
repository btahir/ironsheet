...
- Apache-2.0 license, publishable package metadata, Node 18/20/22 CI matrix, OpenXML SDK validation in CI, contributor docs, issue templates, and runnable examples.
